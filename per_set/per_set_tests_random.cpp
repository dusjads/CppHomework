...
void insert_erase_test () {
    ...
    my_set.erase(my_set.find(50));
    {
        ...
        if (kol != 13) cout << "error insert_erase_test " << kol << "\n";
    }

    persistent_set::iterator my_iter = my_set.find(49);
    my_set.erase(my_iter);
    {
        ...
        if (kol != 12) cout << "error insert_erase_test " << kol << "\n";
    }
    ...
    my_set.erase(my_set.find(55));
    {
        ...
        if (kol != 11) cout << "error insert_erase_test " << kol << "\n";
    }
    ...
    my_set.erase(my_set.find(40));
    {
        ...
        if (kol != 10) cout << "error insert_erase_test " << kol << "\n";
    }
    while (my_set.begin() != my_set.end()) {
        cout << *my_set.begin() << ' ' ;
        my_set.erase(my_set.begin());
